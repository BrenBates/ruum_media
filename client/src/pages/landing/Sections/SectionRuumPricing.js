        ...
        <div className={classes.container}>
          ...
          <GridContainer>
            <GridItem xs={12} sm={4} md={4} className={classes.mlAuto}>
              <Card pricing>
                <CardBody pricing>
                  ...
                  <h1 className={classes.cardTitle}>
                    <small>$</small>49<small>/each</small>
                  </h1>
                  <ul>
                    <li>
                      <b>1</b> HomeSite
            ...
            <GridItem xs={12} sm={4} md={4} className={classes.mrAuto}>
              <Card pricing color="primary">
                <CardBody pricing>
                  ...
                  <h1 className={classes.cardTitleWhite}>
                    <small>$</small>39.99<small>/mo</small>
                  </h1>
                  <ul>
                    <li>
                      <b>Unlimited</b> HomeSites
                    </li>
                    <li>
                      <b>12</b> Pictures
                    </li>
            ...
            <GridItem xs={12} sm={4} md={4} className={classes.mlAuto}>
              <Card pricing>
                <CardBody pricing>
                  <h6 className={classes.cardDescription}>Yearly</h6>
                  <h1 className={classes.cardTitle}>
                    <small>$</small>33.99<small>/mo</small>
                  </h1>
                  <ul>
                    <li>
                      <b>1</b> Project
